...
import { getAllDiscountProducts } from "../service/productsDiscountService";
    ...
    <>
      <Layout>
        <TitlleCustom
          ...
          description={
            "Những sản phẩm này là những sản phẩm giảm giá mà cửa hàng chúng tôi muốn gửi đến bạn "
          }
        />
