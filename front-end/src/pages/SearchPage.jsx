...
const SearchPage = () => {
  ...
  const query = searchParams.get("query"); // Lấy giá trị của tham số 'query'
    ...
    const fetchResults = async () => {
      ...
      try {
        const response = await axios.get(
          "http://localhost:2000/api/search/search",
          {
            params: { query },
          }
        );
        ...
        <Box bg={useColorModeValue("green.100", "gray.800")}>
          ...
          >
            {loading ? (
              ...
              <Text textAlign="center" fontWeight="bold" fontSize="xl" mt="10">
                      ...
                      >
                        ...
                        <Tooltip label="Yêu thích" aria-label="Yêu thích">
                          <IconButton
                            ...
                            color={
                              isFavorite(product._id) ? "red.500" : "black"
                            }
                          />
                        </Tooltip>
