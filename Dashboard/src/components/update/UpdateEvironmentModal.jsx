...
export default function UpdateEvironmentModal({
  ...
  useEffect(() => {
    if (environment) {
      setEnvironmentName(environment?.nameEnviroment); // Cập nhật giá trị cho input
    }
  }, [environment]);
        ...
        <Dialog.Panel className="w-full max-w-xl bg-white p-6 rounded-lg overflow-y-auto max-h-screen scrollbar-thin scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar-thumb-gray-400 scrollbar-track-gray-200">
          ...
          <form>
              ...
              <div className="border-b border-gray-900/10 pb-12">
                <div className="border-b border-gray-900/10 pb-12 text-center">
                  <h2 className="text-base font-semibold leading-7 text-gray-900 flex items-center justify-center">
                    <CloudSunRain className="mr-2" color="#F43F5F" /> Chỉnh sửa
                    môi trường sống
                  </h2>
                    ...
                    <div className="mt-2">
                      <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                        <input
                          ...
                          name="username"
                          type="text"
                          value={environmentName} // Sử dụng classificationName để quản lý giá trị
            ...
            <div className="mt-6 flex items-center justify-end gap-x-6">
              ...
              <button
                onClick={handleUpdateEnviroment}
